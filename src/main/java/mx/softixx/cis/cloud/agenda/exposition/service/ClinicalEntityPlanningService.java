...
public interface ClinicalEntityPlanningService {

	PlanningResponse findOne(MedicalSchedule schedule, Long dcesId);
	
	PlanningResponse findOne(MedicalSchedule schedule, Long dcesId, WeekDay day);
